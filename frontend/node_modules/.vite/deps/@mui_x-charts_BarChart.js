import {
  ...
  useDrawingArea,
  useTicks
} from "./chunk-JLKBXNWN.js";
import {
  NoSsr
} from "./chunk-PUZFEZJM.js";
import {
  Popper
} from "./chunk-XODBNWHU.js";
import {
  Typography_default
} from "./chunk-JGYSE4FN.js";
import "./chunk-Z7PFBYNE.js";
import "./chunk-MFIEHLRW.js";
import {
  useSlotProps
...
var HighlighContext = React4.createContext({
  item: null,
  scope: defaultScope,
  dispatch: () => null
});
...
function HighlightProvider(props) {
  ...
  const [data, dispatch] = React4.useReducer(dataReducer2, {
    item: null,
    scope: defaultScope
  });
...
var useInteractionItemProps = (scope, skip) => {
  ...
  } = React5.useContext(HighlighContext);
  if (skip) {
    return () => ({});
  }
...
var useAggregatedData = () => {
  const seriesData = React7.useContext(SeriesContext).bar ?? {
    series: {},
    stackingGroups: [],
    seriesOrder: []
  };
...
function BarPlot(props) {
  ...
  return (0, import_jsx_runtime4.jsx)(React7.Fragment, {
    children: transition((style, {
      ...
      color: color2,
      highlightScope
    }) => (0, import_jsx_runtime4.jsx)(BarElement, _extends({
      id: seriesId,
      dataIndex,
      highlightScope,
      color: color2
...
function useSeries() {
  const series = React13.useContext(SeriesContext);
  if (series === void 0) {
...
function useChartGradient() {
  ...
  return React16.useCallback((axisId, direction) => `${chartId}-gradient-${direction}-${axisId}`, [chartId]);
}
...
function ZAxisContextProvider(props) {
  ...
  return (0, import_jsx_runtime12.jsx)(ZAxisContext.Provider, {
    value,
    children
  });
}
...
function ChartsItemTooltipContent(props) {
  ...
  const series = React24.useContext(SeriesContext)[itemData.type].series[itemData.seriesId];
  const {
    xAxis,
    yAxis,
    xAxisIds,
...
true ? ChartsItemTooltipContent.propTypes = {
  ...
  contentProps: import_prop_types8.default.shape({
    ...
    getColor: import_prop_types8.default.func,
    ...
    series: import_prop_types8.default.object,
        ...
        children: series.filter(isCartesianSeries).map(({
          ...
          return (0, import_jsx_runtime14.jsxs)(ChartsTooltipRow, {
            ...
            children: [(0, import_jsx_runtime14.jsx)(ChartsTooltipCell, {
              ...
              className: clsx_default(classes.labelCell, classes.cell),
              children: label ? (0, import_jsx_runtime14.jsx)(Typography_default, {
                children: label
              }) : null
            }), (0, import_jsx_runtime14.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.valueCell, classes.cell),
...
function ChartsClipPath(props) {
  ...
  return (0, import_jsx_runtime20.jsx)("clipPath", {
    id,
...
function ChartsGrid(props) {
  ...
  return (0, import_jsx_runtime21.jsxs)(GridRoot, _extends({}, other, {
    className: classes.root,
    children: [vertical && xTicks.map(({
      formattedValue,
      offset
    }) => (0, import_jsx_runtime21.jsx)("line", {
      y1: yScale.range()[0],
      y2: yScale.range()[1],
      x1: offset,
      x2: offset,
...
function ChartsOnAxisClickHandler(props) {
  ...
  return (0, import_jsx_runtime22.jsx)(React33.Fragment, {});
}
...
var BarChart = React37.forwardRef(function BarChart2(props, ref) {
  ...
  return (0, import_jsx_runtime26.jsxs)(ResponsiveChartContainer, {
    ref,
    ...
    children: [onAxisClick && (0, import_jsx_runtime26.jsx)(ChartsOnAxisClickHandler, {
      onAxisClick
    }), grid && (0, import_jsx_runtime26.jsx)(ChartsGrid, {
      vertical: grid.vertical,
      horizontal: grid.horizontal
    }), (0, import_jsx_runtime26.jsxs)("g", {
      clipPath: `url(#${clipPathId})`,
      children: [(0, import_jsx_runtime26.jsx)(BarPlot, {
        slots,
        slotProps,
        skipAnimation: skipAnimation2,
        onItemClick
      }), (0, import_jsx_runtime26.jsx)(ChartsOverlay, {
        loading,
        slots,
        slotProps
      })]
    }), (0, import_jsx_runtime26.jsx)(ChartsAxis, {
      topAxis,
      leftAxis,
      rightAxis,
      bottomAxis,
      slots,
      slotProps
    }), (0, import_jsx_runtime26.jsx)(ChartsLegend, _extends({}, legend, {
      slots,
      slotProps
    })), (0, import_jsx_runtime26.jsx)(ChartsAxisHighlight, _extends({}, defaultizedAxisHighlight)), !loading && (0, import_jsx_runtime26.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slots,
      slotProps
    })), (0, import_jsx_runtime26.jsx)(ChartsClipPath, {
      id: clipPathId
    }), children]
  });
});
true ? BarChart.propTypes = {
   ...
   * @default 'vertical'
   */
  layout: import_prop_types18.default.oneOf(["horizontal", "vertical"]),
  /**
   ...
   */
  legend: import_prop_types18.default.shape({
